...
export const env = Object.freeze({
  ...
  loginUrl: process.env.ADMIN_LOGIN_URL ?? "http://localhost:3001/login",
  ...
  growthLoopPublicBaseUrl: (process.env.GROWTH_LOOP_PUBLIC_BASE_URL ?? process.env.NEXT_PUBLIC_APP_URL ?? "http://localhost:3001").replace(/\/$/, ""),
