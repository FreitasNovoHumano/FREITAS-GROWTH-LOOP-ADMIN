...
export default function LoginPage() {
  return <main className="login-shell">
    <section className="login-story">
      <div className="brand"><span className="brand-mark"><Orbit /></span><span>Freitas Growth <b>Loop</b></span></div>
    ...
    <section className="login-panel"><div className="login-card"><span className="mini-logo"><Orbit/></span><h2>Bem-vindo ao Growth Loop</h2><p>Entre com a mesma conta usada na Freitas Growth AI.</p><button className="google-button" onClick={() => signIn("google", { callbackUrl: "/dashboard" })}><span className="google-g">G</span> Continuar com Google <ArrowRight size={18}/></button><small>Ao continuar, você concorda com os Termos de Uso e a Política de Privacidade.</small></div></section>
  </main>;
}
